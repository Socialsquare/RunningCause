...
if os.getenv('RUNKEEPER_CLIENT_ID'):
    SECRET_KEY = os.getenv('RUNKEEPER_CLIENT_ID')
else:
    SECRET_KEY = 'BOGUS CLIENT ID -- CHANGE THIS'

if os.getenv('RUNKEEPER_CLIENT_SECRET'):
    SECRET_KEY = os.getenv('RUNKEEPER_CLIENT_SECRET')
else:
    SECRET_KEY = 'BOGUS CLIENT SECRET -- CHANGE THIS'    
