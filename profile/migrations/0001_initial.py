    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stripe_customer_id', models.CharField(default=None, max_length=200, blank=True, null=True, verbose_name=b'Stripe Customer Id', db_index=True)),
            ...
            managers=[
                ('objects', profile.models.MasangaUserManager()),
            ],
        ),
    ]
