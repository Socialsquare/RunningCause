...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='run',
            name='end_date',
            field=models.DateField(default=datetime.date(2015, 4, 17), verbose_name=b'End Date'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='run',
            name='start_date',
            field=models.DateField(default=datetime.date(2015, 4, 17), verbose_name=b'Date'),
            preserve_default=True,
        ),
        migrations.AlterField(
            model_name='sponsorship',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('remind_date', models.DateField(default=datetime.date(2015, 5, 17), null=True, verbose_name=b'Remind Date')),
